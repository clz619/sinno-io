 ...
 * @date 2017/11/9
 */
public class CsvFormatTest_1110_1 {


  String OUT_PATH = "/Users/chenlizhong/Documents/out-20171110-01";
...
//              lines.add(lineArray);
    ...
    String sourcePath3 = "/Users/chenlizhong/Documents/20171110-01/2";

    File file3 = new File(sourcePath3);
    File[] childFiles3 = file3.listFiles();
    for (File cfile3 : childFiles3) {
      if (cfile3.isDirectory()) {
        File[] csvs = cfile3.listFiles(new FileFilter() {
          @Override
          public boolean accept(File pathname) {
            return pathname.getName().endsWith(".csv");
          }
...
//          && j < 100
          ...
          System.out.println(".csv 3 count:" + count + " useTs:" + (iet - ist) + "ms");
        }

      }
    }

//    System.out.println("read map size" + mobiles.size());
